...
!function(e) {
    ...
    ;
    var o, i = !0, c = "69e1ea15ca52fad0d45f", a = {}, d = [], s = [];
    function p(n) {
        var r = {
...
//# sourceMappingURL=runtime-69e1ea.js.map


p = get_sign("M0uz")
s =p.generateIv();
console.log(s)
a ='{"encCompanyId": "1nR-298~","questionId": "","optionId": ""}'
n =p.encryptAES(a, {iv: "HNRvqY7MKFNXLIk3"}).replace(/\//g, "_").replace(/\+/g, "-").replace(/=/g, "~");

console.log(n)
/*uLM6iPh7613C0ynm
  R0bHe94N36TNzRe4
  l2WHV3oUG1NIamvrLuLv_g~~
  "Ea5bdzx6esqJbwu_KU8mVAJjYwtDe2mtZLx_RQyIQXaeSBPZ8cxLL9e5rkzM2N2xX58W5oBkfi7rYJs5wV8nWQ~~"
...
// a = '{"encCompanyId":"1nR-298~","questionId":"","optionId":""}'
// n = p.encryptAES(a, {iv: s = "uLM6iPh7613C0ynm"
// }).replace(/\//g, "_").replace(/\+/g, "-").replace(/=/g, "~");
// console.log(n)


//data
var data= ""
d = p.decryptAES(data, {iv:"yiC03YE0LNGetW3J"})
// d = JSON.parse(d)
console.log(d)